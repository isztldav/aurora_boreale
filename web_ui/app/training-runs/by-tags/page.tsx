...
export default function TaggedRunsPage() {
  ...
  // Fetch runs for selected tag
  const { data: runs = [], isLoading: runsLoading } = useQuery({
    queryKey: ['runs-by-tag', selectedTagId, includeDescendants],
    queryFn: () => selectedTagId ? fetchRunsByTag(selectedTagId, includeDescendants) : [],
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Training Runs by Tags</h1>
            <p className="text-muted-foreground">
              Browse and filter training runs organized by your tag hierarchy
            </p>
          </div>
        </div>
                  ...
                  <div>
                    ...
                    <CardDescription>
                      {selectedTag ? (
                        ...
                        "Select a tag from the hierarchy to view training runs"
                      )}
                    </CardDescription>
                  </div>
              ...
              <CardContent>
                {selectedTag ? (
                  ...
                  <div className="text-center py-12 text-muted-foreground">
                    ...
                    <p>Select a tag from the hierarchy to view its associated training runs.</p>
                  </div>
                )}
              </CardContent>
            </Card>
